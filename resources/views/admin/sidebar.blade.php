		...
		<div class="wrapper" style="margin-bottom:90px">
			<ul class="nav nav-sidebar" id="sidebar-menu">
               ...
               @if(Auth::user()->usertype=='Admin')
	                ...
	                <li class="{{classActivePath('news')}}"><a href="{{ URL::to('admin/news') }}"><i class="fa fa-file-text"></i> News</a></li>
	                
	                <li class="{{classActivePath('slidernews')}}"><a href="{{ URL::to('admin/slidernews') }}"><i class="fa fa-sliders"></i>Home Slider</a></li>
	                
	                <li class="{{classActivePath('featurednews')}}"><a href="{{ URL::to('admin/featurednews') }}"><i class="fa fa-heart"></i>Featured News</a></li>
	                <li class="{{classActivePath('users')}}"><a href="{{ URL::to('admin/users') }}"><i class="fa fa-users"></i>Editors</a></li>
	                
	                <li class="{{classActivePath('widgets')}}"><a href="{{ URL::to('admin/widgets') }}"><i class="fa fa-plus"></i>Widgets</a></li>

	                <li class="{{classActivePath('addition')}}"><a href="{{ URL::to('admin/addition') }}"><i class="fa fa-bookmark"></i>Addition</a></li>
