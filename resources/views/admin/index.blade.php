...
<!--
                <div class="avatar">
                    <img src="{{ URL::asset('images/guy.jpg') }}" alt="guy" class="img-circle img-responsive"/>
                </div>
-->
				...
				<span aria-hidden="true">&times;</span></button>
                    ...
                    <div class="form-group text-center">
                        <button type="submit" class="btn btn-orange">Login <i class="md md-lock-open"></i></button>
                    </div>
                {!! Form::close() !!} 
            </div>
