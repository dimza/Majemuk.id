...
<!-- PAGE CONTENTS STARTS
			...
			<section class="inner-page-contents">
				<div class="row">
					@if(getcong('search_post_columns')=='1cls' or getcong('search_post_columns')=='2cls' or getcong('search_post_columns')=='3cls')
						...
						<article class="{{$class_name}} post_min_height">
							<div class="picture">
								<div class="category-image">
									...
									@if(getcong('search_post_columns')=='1cls' or getcong('search_post_columns')=='1crs' or getcong('search_post_columns')=='2cns')
				...
				<!-- /. LATEST ARTICLES ENDS
					...
					<!-- /. LEFT COLUMN ENDS
						========================================================================= --> 
					@if(getcong('search_post_columns')=='1crs' or getcong('search_post_columns')=='2crs' or getcong('search_post_columns')=='3crs')
						@include("_particles.sidebar")
					@endif
				</div>
